...
balanced_tuning_sample = random.sample(training_data_no_tags, 100000) + random.sample(training_data_all_else, 100000)
...
def create_model():
    ...
    peft_config = LoraConfig(
        ...
        lora_dropout=0.04433838638729353, #insert dropout from hyperparameter tuning script
        use_rslora=True,
        bias="none",
        task_type="CAUSAL_LM",
    )
...
trainer = Trainer(
    ...
    args=TrainingArguments(
        ...
        learning_rate=6.426829614559691e-05, #insert from hyperparameter tuning script
        save_strategy="steps",
        save_steps=500,
        eval_strategy="steps",
        eval_steps=500,
